...
int cock=0;       //  cockpit view
int falc=1;       //  display falcon
				  ...
				  double th, unsigned int duralloy)
{
   ...
   //reactor core
   reactcore(0,0,0,0,0,0,0, duralloy);
   reactcore(0,0,-1,0,0,0,0.0, duralloy);
   corewalls(0,0,0,0,0,0,0);
   
   reactcore(0,-8.4,0,1,0,0,180, duralloy);
   reactcore(0,-8.4,-1,1,0,0,180, duralloy);
   ...
   tunl_hull_conn(0,0,0,0,0,0, duralloy);
...
void display()
{
   ...
   if (light)
   {
     ...
     glDisable(GL_LIGHTING);
      ...
      falcon1(-4, 0,-4,1,1,1,270, texture[0]);
